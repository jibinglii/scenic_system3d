(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'iclient9-plot-leaflet')) {
            inputCSS(" libs/plotting/leaflet/9.1.2/iclient9-plot-leaflet.css");
            if (supportES6()) {
                inputScript(" libs/plotting/leaflet/9.1.2/iclient9-plot-leaflet-es6.min.js");
            } else {
                inputScript(" libs/plotting/leaflet/9.1.2/iclient9-plot-leaflet.min.js");
            }
        }
