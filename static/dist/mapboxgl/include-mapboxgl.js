(function () {
    ...
    function load() {
        ...
        if (inArray(includes, 'echarts')) {
            ...
            inputScript("../../web/libs/echarts-liquidfill/echarts-liquidfill.js");
        ...
        if (inArray(includes, 'element')) {
            inputCSS("../../web/libs/element-ui/2.7.2/lib/theme-chalk/index.css");
            inputScript("../../web/libs/element-ui/2.7.2/lib/index.js");
        }
